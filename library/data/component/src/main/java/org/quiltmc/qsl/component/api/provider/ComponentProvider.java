 ...
 *
 * <p>
 * Currently, it consists of the {@link ComponentProvider#getComponentContainer()} method, which is the abstract one,
 ...
 * @see Components
 */
@InjectedInterface({ // We inject this interface, so that modders don't need to use the methods in Components directly with our default implementations.
		Entity.class,
		BlockEntity.class,
		Chunk.class,
...
public interface ComponentProvider {
	 ...
	 * so that it can store the components targeting or that are manually added to it.
	 *
